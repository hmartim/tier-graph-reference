# T01 — Persistent relation across successive source states

**Operation:** `getRelationHistory`  
**Competency questions:** CQ5, CQ6

## Purpose

Tests proposition persistence without creating one relation per legal version.
